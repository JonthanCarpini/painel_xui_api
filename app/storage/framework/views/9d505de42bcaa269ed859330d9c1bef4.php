<?php $__env->startSection('title', 'Links M3U'); ?>
    ...
    <div class="bg-dark-300 rounded-xl p-8 border-2 border-orange-500/50">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-2xl font-bold text-white flex items-center gap-2">
                ...
                Links de Acesso - <?php echo e($client['username']); ?>

            </h2>
            <a href="<?php echo e(route('clients.index')); ?>" class="text-gray-400 hover:text-white transition-colors">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-dark-300 rounded-xl border border-dark-200 p-6">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <input type="text" id="m3uUrl" value="<?php echo e($m3u_url); ?>" readonly class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white font-mono text-sm">
        ...
        <div class="bg-dark-300 rounded-xl border border-dark-200 p-6">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <input type="text" id="hlsUrl" value="<?php echo e($hls_url); ?>" readonly class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white font-mono text-sm">
        ...
        <div class="bg-dark-300 rounded-xl border border-dark-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="username" value="<?php echo e($client['username']); ?>" readonly class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="password" value="<?php echo e($client['password']); ?>" readonly class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white">
...
document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape') {
        window.location.href = '<?php echo e(route('clients.index')); ?>';
    }
});
</script>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\Documents\Projetos\painel_xui\app\resources\views/clients/m3u.blade.php ENDPATH**/ ?>