<?php $__env->startSection('title', 'Meus Clientes'); ?>
...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex gap-3">
        ...
        <a href="<?php echo e(route('clients.create')); ?>" class="px-4 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg hover:shadow-lg transition-all flex items-center gap-2">
...
<div class="bg-dark-300 rounded-xl border border-dark-200 overflow-hidden">
    <div id="clientsTableContainer">
        <?php echo $__env->make('clients.partials.table', ['clients' => $clients], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    
    <div id="paginationContainer" class="p-6 border-t border-dark-200">
        <?php echo $__env->make('clients.partials.pagination', ['clients' => $clients], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
</div>
...
<?php if(false): ?>
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-dark-200">
                ...
                ?>
                <tr class="hover:bg-dark-200 transition-colors duration-150" data-username="<?php echo e($client['username']); ?>" data-password="<?php echo e($client['password']); ?>" data-status="<?php echo e($isExpired ? 'expired' : 'active'); ?>" data-trial="<?php echo e($client['is_trial'] ?? 0); ?>" data-exp="<?php echo e($expDate); ?>" data-created="<?php echo e($client['created_at'] ?? 0); ?>">
                    <td class="px-6 py-4">
                        <span class="text-white font-medium"><?php echo e($client['username']); ?></span>
                    </td>
                    <td class="px-6 py-4">
                        <code class="text-gray-300 text-sm"><?php echo e($client['password']); ?></code>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-gray-400 text-sm"><?php echo e($client['member_id'] ?? 'N/A'); ?></span>
                    </td>
                    <td class="px-6 py-4">
                        <?php if(isset($client['is_trial']) && $client['is_trial'] == 1): ?>
                    ...
                    <td class="px-6 py-4">
                        <span class="text-gray-300 text-sm"><?php echo e(isset($client['created_at']) ? date('d/m/Y, H:i', is_numeric($client['created_at']) ? $client['created_at'] : strtotime($client['created_at'])) : 'N/A'); ?></span>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-sm <?php echo e($isExpired ? 'text-red-400' : ($daysLeft <= 7 ? 'text-yellow-400' : 'text-gray-300')); ?>">
                            <?php echo e(date('d/m/Y, H:i', $expDate)); ?>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-1">
                            ...
                            <span class="text-white font-semibold"><?php echo e($client['max_connections'] ?? 1); ?></span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <?php if(isset($client['enabled']) && $client['enabled'] == 1 && !$isExpired): ?>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-1">
                            <button onclick="openM3uModal(<?php echo e($client['id']); ?>, '<?php echo e($client['username']); ?>')" class="p-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors" title="Links M3U">
                                <i class="bi bi-link-45deg"></i>
                            </button>
                            <button onclick="openEditModal(<?php echo e($client['id']); ?>)" class="p-2 bg-gray-600 text-white rounded hover:bg-gray-700 transition-colors" title="Editar">
                                <i class="bi bi-pencil"></i>
                            </button>
                            <button onclick="openRenewModal(<?php echo e($client['id']); ?>)" class="p-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors" title="Renovar">
                                <i class="bi bi-arrow-clockwise"></i>
                            </button>
                            <button onclick="killConnections(<?php echo e($client['id']); ?>)" class="p-2 bg-orange-600 text-white rounded hover:bg-orange-700 transition-colors" title="Destruir Conexão">
                                <i class="bi bi-x-circle"></i>
                            </button>
                            <a href="<?php echo e(route('clients.m3u', $client['id'])); ?>" class="p-2 bg-purple-600 text-white rounded hover:bg-purple-700 transition-colors" title="Download M3U" download>
                                <i class="bi bi-download"></i>
                            </a>
                            <button onclick="deleteClient(<?php echo e($client['id']); ?>)" class="p-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors" title="Excluir">
    ...
    <div class="text-center py-16">
        ...
        <a href="<?php echo e(route('clients.create')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg hover:shadow-lg transition-all">
            <i class="bi bi-plus-circle"></i>
            ...
            <div class="mb-4">
                ...
                <select id="renewPackageId" name="package_id" required class="w-full px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white focus:border-orange-500 focus:outline-none" onchange="updateRenewPackage(this)">
                    ...
                    <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($package->is_official == 1): ?>
                            <option value="<?php echo e($package->id); ?>" 
                                    data-duration="<?php echo e($package->official_duration ?? 30); ?>"
                                    data-duration-in="<?php echo e($package->official_duration_in ?? 'days'); ?>"
                                    data-connections="<?php echo e($package->max_connections ?? 1); ?>"
                                    data-bouquets="<?php echo e($package->bouquets ?? '[]'); ?>"
                                    data-credits="<?php echo e($package->official_credits ?? 0); ?>">
                                <?php echo e($package->package_name); ?> 
                                - <?php echo e($package->official_duration ?? 30); ?> <?php echo e($package->official_duration_in ?? 'dias'); ?>

                                (<?php echo e($package->official_credits); ?> crédito<?php echo e($package->official_credits > 1 ? 's' : ''); ?>)
                            </option>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <div id="trialBouquets" class="grid grid-cols-2 gap-3 max-h-64 overflow-y-auto p-4 bg-dark-200 rounded-lg">
                    <?php $__currentLoopData = $bouquets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bouquet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-3 p-3 bg-dark-300 rounded-lg hover:bg-dark-100 cursor-pointer transition-colors">
                            <input type="checkbox" name="bouquet_ids[]" value="<?php echo e($bouquet['id']); ?>" class="w-5 h-5 text-orange-500 bg-dark-200 border-dark-100 rounded focus:ring-orange-500">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\admin\Documents\Projetos\painel_xui\app\resources\views/clients/index.blade.php ENDPATH**/ ?>