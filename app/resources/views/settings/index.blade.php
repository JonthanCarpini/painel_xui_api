    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-dark-300 rounded-xl border border-gray-200 dark:border-dark-200 p-6 shadow-sm dark:shadow-none">
                ...
                <div class="space-y-2 text-sm max-h-60 overflow-y-auto custom-scrollbar">
                    @foreach($apps as $app)
                    <div class="bg-gray-50 dark:bg-dark-200 p-3 rounded group hover:bg-gray-100 dark:hover:bg-dark-100 transition-colors">
                        <div class="font-bold text-gray-900 dark:text-white mb-1">{{ $app->name }}</div>
...
<script>
    ...
    function editApp(app) {
        // Implementar lógica de preencher formulário para edição
        // Por simplicidade, scroll para o form e focar no nome
