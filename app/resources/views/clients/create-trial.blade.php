        ...
        <div class="p-6">
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="successUsername" readonly value="{{ session('trial_success')['username'] }}" class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white font-mono">
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        <input type="text" id="successPassword" readonly value="{{ session('trial_success')['password'] }}" class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white font-mono">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="text" readonly value="{{ session('trial_success')['exp_date'] }}" class="w-full px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-2">Conexões</label>
                    <input type="text" readonly value="{{ session('trial_success')['max_connections'] }}" class="w-full px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white">
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex gap-2">
                    <input type="text" id="successM3u" readonly value="{{ session('trial_success')['m3u_url'] }}" class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white font-mono text-sm">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-2">
                    <input type="text" id="successHls" readonly value="{{ session('trial_success')['hls_url'] }}" class="flex-1 px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white font-mono text-sm">
        ...
        <div class="bg-dark-300 rounded-xl border border-dark-200 p-6">
            <form action="{{ route('clients.store-trial') }}" method="POST">
                            ...
                            @if($package->is_trial == 1)
                                <option value="{{ $package->id }}" 
                                    ...
                                    @if($package->trial_credits > 0)
                                        ({{ $package->trial_credits }} crédito{{ $package->trial_credits > 1 ? 's' : '' }})
                                    @else
                                        (Grátis)
                                    @endif
                                </option>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" rows="3" class="w-full px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg text-white focus:border-orange-500 focus:outline-none" placeholder="Anotações sobre este teste">{{ old('notes') }}</textarea>
                </div>
